  ...
  <section className={styles.projects}>
    <div className={styles.container}>
      ...
      <div className={styles.project}>
        ...
        <p>Created an interactive kids' park using OpenGL, incorporating animations, to enhance textures, and various visual effects for an improved user experience.</p>
      </div>
