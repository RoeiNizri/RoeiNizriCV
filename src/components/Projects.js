    ...
    <section className={styles.projects}>
      <div className={styles.container}>
        ...
        <div className={styles.project}>
          ...
          <a href="https://github.com/RoeiNizri/MyProjects/tree/master/OpenGL%20Project%20Kids%20Park" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
        </div>
        ...
        <div className={styles.project}>
          ...
          <a href="https://github.com/RoeiNizri/MyProjects/tree/master/Application%20for%20Managing%20a%20Drinking%20System" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
        </div>
        ...
        <div className={styles.project}>
          ...
          <a href="https://github.com/RoeiNizri/MyProjects/tree/master/Restaurant%20Shell%20Menu" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
        </div>
        ...
        <div className={styles.project}>
          ...
          <a href="https://github.com/RoeiNizri/MyProjects/tree/master/Student%20Management%20System%20Using%20Files" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
        </div>
        ...
        <div className={styles.project}>
          ...
          <a href="https://github.com/RoeiNizri/MyProjects/tree/master/Minefield%20Game" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
        </div>
        ...
        <div className={styles.project}>
          ...
          <a href="https://github.com/RoeiNizri/MyProjects/tree/master/MDB" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
        </div>
        ...
        <div className={styles.project}>
          ...
          <a href="https://github.com/RoeiNizri/MyProjects/tree/master/Digress" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
        </div>
        ...
        <div className={styles.project}>
          ...
          <a href="https://github.com/RoeiNizri/MyProjects/tree/master/Message%20Encryption" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
        </div>
        ...
        <div className={styles.project}>
          ...
          <a href="https://github.com/RoeiNizri/MyProjects/tree/master/Space%20Invaders%20Real%20RTS" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
        </div>
      </div>
    </section>
  );
